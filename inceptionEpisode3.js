...
//home work
const headerElem = React.createElement('div',{id:'header'},
[React.createElement('h1',{className:'title'}, "This is h1 tag from element"),
React.createElement('h2',{className:'title'}, "This is h2 tag from element"),
React.createElement('h3',{className:'title'}, "This is h3 tag from element")]
)

const headerElemJSX = (
    <div id="header">
        <h1 className='title' id="text" target="ele">This is h1 tag from JSX</h1>
        <h2 className='title'>This is h2 tag from JSX</h2>
        <h3 className='title'>This is h3 tag from JSX</h3>
    </div>
)

const TitleComp1 = () =>(
    <div id="title">
        <h1 className='title'>This is h1 tag from title component</h1>
    </div>
)
const TitleComp2 = () =>(
    <div id="title">
        <h2 className='title'>This is h2 tag from title component</h2>
    </div>
)
const TitleComp3 = () =>(
    <div id="title">
        <h3 className='title'>This is h3 tag from title component</h3>
    </div>
)
const TitleComp4 = () =>(
    <div id="title">
        <h4 className='title'>This is h4 tag from title component</h4>
    </div>
)
const TitleComp5 = () =>(
    <React.Fragment>
    ...
    <div id="title">
    //comments
        <h5 className='title'>This is h5 tag from title component</h5>
    </div>
    <h6 className='title'>React fragment from TitleComp5</h6>
    </React.Fragment>
)
...
const HeaderCompJSX = () =>(
    ...
    <div id="header">
        <TitleComp1 />
        <TitleComp2 /><TitleComp2 />
        {TitleComp3()}
        {TitleComp4()}
        <TitleComp5 />
    </div>
    <h6 className='title'>This is h6 tag from title component</h6>
    <h6 className='title'>React fragment from HeaderCompJSX</h6>
    </>
)
...
const headerComp = ReactDOM.createRoot(document.getElementById('headerComp'));
...
const rootComp = ReactDOM.createRoot(document.getElementById('rootComp'));
headerComp.render(<HeaderComponent />);
rootElem.render(headerElem);
rootJSX.render(headerElemJSX);
rootComp.render(<HeaderCompJSX />);
